...
class OpenApiConfiguration {
    ...
    OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info().title("Spring Boot Template").description("A ready to use spring boot template"))
                .components(
                        new Components()
                                .addSecuritySchemes(BASIC_AUTH_SECURITY_SCHEME, new SecurityScheme()
